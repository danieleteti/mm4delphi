...
type
  ...
  published
    ...
    property OverColorLight: TColor index 9 read FOverColorLight write
      SetColors;
    property OverColorBorder: TColor index 10 read FOverColorBorder write
      SetColors;
    ...
    property DownColorLight: TColor index 15 read FDownColorLight write
      SetColors;
    property DownColorBorder: TColor index 16 read FDownColorBorder write
      SetColors;
    property DownColorText: TColor index 17 read FDownColorText write SetColors;
    property DisabledColorFace: TColor index 18 read FDisabledColorFace write
      SetColors;
    property DisabledColorGrad: TColor index 19 read FDisabledColorGrad write
      SetColors;
    property DisabledColorDark: TColor index 20 read FDisabledColorDark write
      SetColors;
    property DisabledColorLight: TColor index 21 read FDisabledColorLight write
      SetColors;
    property DisabledColorBorder: TColor index 22 read FDisabledColorBorder write
      SetColors;
    property DisabledColorText: TColor index 23 read FDisabledColorText write
      SetColors;
    property ColorFocusRect: TColor index 24 read FColorFocusRect write
      SetColors;
    ...
    property TransparentGlyph: Boolean read FTransparentGlyph write
      SetTransparentGlyph;
...
begin
  ...
  if FGradient then
  begin
    GradientFillRect(BtnBmp.Canvas, Rect(0, 0, Width, Height), FaceColor,
      GradColor);
  end;
...
procedure TXiButton.MouseDown(Button: TMouseButton; Shift: TShiftState; X, Y:
  Integer);
begin
  inherited;
...
procedure TXiButton.MouseUp(Button: TMouseButton; Shift: TShiftState; X, Y:
  Integer);
begin
  inherited;
  FClicked := False;
...
begin
  ...
  begin
    ...
    else if (FDefault and (CharCode = VK_RETURN) and CanFocus) then
    begin
      Click;
      Result := 1;
    end
