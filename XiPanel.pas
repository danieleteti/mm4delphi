...
type
  ...
  published
    ...
    property FillDirection: TFillDirection read FFillDirection write
      SetFillDirection;
    property Align;
    property Alignment;
    property Anchors;
...
begin
  ...
  case Alignment of
    ...
    taRightJustify: i := ClientWidth - BevelWidth - 2 -
      ScrBmp.Canvas.TextWidth(Caption);
  ...
  ScrBmp.Canvas.TextOut(i, (ClientHeight - ScrBmp.Canvas.TextHeight('AaBbCcDd'))
    div 2, Caption);
  ...
  if BevelOuter <> bvNone then
    case BevelInner of
      bvRaised: DrawFrame(ScrBmp.Canvas, BevelWidth, BevelWidth, FColorLight,
        FColorDark);
      bvLowered: DrawFrame(ScrBmp.Canvas, BevelWidth, BevelWidth, FColorDark,
        FColorLight);
      bvSpace: DrawFrame(ScrBmp.Canvas, BevelWidth, BevelWidth, FColorLight,
        FColorDark);
    end
  else
    case BevelInner of
      bvRaised: DrawFrame(ScrBmp.Canvas, 0, BevelWidth, FColorLight,
        FColorDark);
      bvLowered: DrawFrame(ScrBmp.Canvas, 0, BevelWidth, FColorDark,
        FColorLight);
      bvSpace: DrawFrame(ScrBmp.Canvas, 0, BevelWidth, FColorLight, FColorDark);
    end;
...
procedure TXiPanel.DrawBevel(Canvas: TCanvas; Rect: TRect; LightColor,
  DarkColor: TColor);
begin
  Canvas.Pen.Width := 1;
...
procedure TXiPanel.DrawFrame(Canvas: TCanvas; Offset, FrameWidth: Integer;
  LightColor, DarkColor: TColor);
var
  i: integer;
begin
